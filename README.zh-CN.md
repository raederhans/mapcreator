<div align="center">
  ...
  Scenario Forge 是一个以世界场景为核心的地图创作工作台，适合架空历史、策略游戏 Mod、国家版图故事和地图展示。
...
- **场景基线：** 从 Blank Map、Modern World、HOI4 1936、HOI4 1939 或 TNO 1962 开始创作。
...
- **交通工作台：** 检查道路、铁路、机场、港口、矿产、能源设施、工业区、物流节点和图层顺序。
- **双语导出流程：** 使用英文或简体中文界面，保存可编辑项目文件，并导出 PNG/JPG 或最高 8K 的高分辨率图片。
