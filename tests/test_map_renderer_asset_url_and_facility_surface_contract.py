...
class MapRendererAssetUrlAndFacilitySurfaceContractTest(unittest.TestCase):
    def test_map_renderer_uses_asset_url_policy_owner_for_bathymetry_urls(self):
        ...
        self.assertIn("return getRendererAssetUrlPolicyOwner().getScenarioBathymetryTopologyUrl(...args);", renderer_content)
        self.assertIn("return getRendererAssetUrlPolicyOwner().getDesiredBathymetryTopologyUrl(...args);", renderer_content)
    ...
    def test_map_renderer_uses_facility_surface_owner_for_tooltip_and_card_dom(self):
        ...
        self.assertIn("return getFacilitySurfaceOwner().buildFacilityTooltipText(...args);", renderer_content)
