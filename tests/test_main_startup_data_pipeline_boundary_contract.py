...
class MainStartupDataPipelineBoundaryContractTest(unittest.TestCase):
    ...
    def test_owner_keeps_context_layer_and_hydration_contracts(self):
        ...
        self.assertIn("SCENARIO_STARTUP_LOCALES_FILENAME", owner_content)
        self.assertIn("SCENARIO_STARTUP_GEO_ALIASES_FILENAME", owner_content)
        self.assertIn("const startupScenarioLocalesUrl = getStartupScenarioSupportUrl(", owner_content)
        self.assertIn("const startupScenarioGeoAliasesUrl = getStartupScenarioSupportUrl(", owner_content)
        self.assertIn("localesUrl: startupScenarioLocalesUrl || null,", owner_content)
        self.assertIn("geoAliasesUrl: startupScenarioGeoAliasesUrl || null,", owner_content)
