...
class MapRendererBorderMeshOwnerBoundaryContractTest(unittest.TestCase):
    def test_map_renderer_keeps_border_render_owner_while_border_facade_hosts_wrappers(self):
        ...
        self.assertIn("getBorderMeshOwner().getFrontlineOwnershipContext()", renderer_content)
        self.assertIn("getBorderMeshOwner().getFrontlineMesh()", renderer_content)
        self.assertIn("getScenarioSurfaceVersionSignal,", renderer_content)
        self.assertNotIn("function getFrontlineOwnershipContext() {", renderer_content)
        self.assertNotIn("function getFrontlineMesh() {", renderer_content)
        ...
        self.assertIn("function getFrontlineOwnershipContext() {", owner_content)
        self.assertIn("function getFrontlineMesh() {", owner_content)
        self.assertIn("return getDynamicBorderOwnershipContext(state);", owner_content)
        self.assertIn("state.cachedFrontlineMesh = null;", owner_content)
        self.assertIn("state.cachedFrontlineMeshHash = \"\";", owner_content)
