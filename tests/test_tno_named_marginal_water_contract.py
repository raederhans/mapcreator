...
TARGET_DETAIL_PARENT_MAP = {
    ...
    'tno_menai_strait': 'tno_irish_sea',
    'tno_liverpool_bay': 'tno_irish_sea',
    'tno_morecambe_bay': 'tno_irish_sea',
    'tno_solway_firth': 'tno_irish_sea',
    'tno_belfast_lough': 'tno_north_channel',
...
NON_OVERLAP_PAIRS = [
    ...
    ('tno_baltic_sea', 'tno_bay_of_bothnia'),
    ...
    ('tno_irish_sea', 'tno_menai_strait'),
    ('tno_irish_sea', 'tno_liverpool_bay'),
    ('tno_irish_sea', 'tno_morecambe_bay'),
    ('tno_irish_sea', 'tno_solway_firth'),
    ('tno_north_channel', 'tno_belfast_lough'),
