...
class ScenarioLifecycleRuntimeBoundaryContractTest(unittest.TestCase):
    def test_lifecycle_runtime_owns_reset_clear_transaction(self):
        ...
        self.assertIn("runtimeState.scenarioHydrationHealthGate = createDefaultScenarioHydrationHealthGate();", content)
        self.assertIn("runtimeState.scenarioDataHealth = createDefaultScenarioDataHealth(", content)
