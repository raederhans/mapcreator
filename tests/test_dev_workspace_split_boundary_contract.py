...
class DevWorkspaceSplitBoundaryContractTest(unittest.TestCase):
    ...
    def test_scenario_tag_creator_owner_moves_to_controller(self):
        ...
        self.assertIn("const TAG_CREATOR_PALETTE_SWATCH_LIMIT = 14;", owner_content)
        self.assertIn(".slice(0, TAG_CREATOR_PALETTE_SWATCH_LIMIT);", owner_content)
        self.assertNotIn(".slice(0, 18);", owner_content)
