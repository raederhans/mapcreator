...
function updateUIText() {
  ...
  const uiMap = [
    ...
    ["lblPhysicalIntensityFieldEnabled", "Enable Intensity Field"],
    ["lblPhysicalIntensityFieldWeight", "Weight"],
    ["lblPhysicalIntensityFieldRadius", "Radius"],
    ["physicalIntensityFieldStampCenterBtn", "Stamp Center Brush"],
    ["physicalIntensityFieldAddCenterBtn", "Add Center Point"],
    ["physicalIntensityFieldClearBtn", "Clear"],
