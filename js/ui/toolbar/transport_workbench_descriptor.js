...
const TRANSPORT_WORKBENCH_FAMILY_COPY = Object.freeze({
  ...
  industrial_zones: Object.freeze({
    ...
    lensBody: "Industrial land now runs as a multi-country family: polygon packs and point-center packs stay source-separated under the active carrier.",
    lensNext: "The carrier renders the active pack contract directly, keeping source lineage visible across polygon and point-center variants.",
    previewTitle: "Industrial land carrier",
    previewCaption: "The carrier now shows the live industrial land pack and keeps polygon and point-center provenance explicit instead of fusing them.",
    inspectorTitle: "Industrial land inspector",
    inspectorBody: "This side now reports the active industrial-land variant, source lineage, build counts, and the selected site attributes without inventing one merged geometry truth.",
    inspectorEmptyTitle: "No industrial site selected",
    inspectorEmptyBody: "Click an industrial site in the carrier to inspect its active variant, source member, and site attributes.",
  }),
