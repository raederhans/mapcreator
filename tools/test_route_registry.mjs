...
const INFRASTRUCTURE_ROUTES = [
  ...
  },
  {
    ...
    sourceRef: "AGENTS.md,docs/testing,docs/active/_worktree_registry.md,docs/archive/sf-ats-wp2-supervisor-plan-20260702,tools/ai_test_supervisor,tests/supervisor_domain_registry_behavior.test.mjs,tests/supervisor_schema_contracts.test.mjs",
    domain: "test-routing",
    ownerHint: "test-infra",
    layer: "contract",
    cost: "fast",
