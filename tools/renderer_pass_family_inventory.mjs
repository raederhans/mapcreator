...
export const RENDER_PASS_FAMILY_INVENTORY = Object.freeze([
  ...
  freezeRecord({
    ...
    perfSensitivity: "high",
    notes: "P3.3b pass-level orchestration owner; worker client, packet builder, fine traversal, state effects, and accepted-result render request remain composition-root dependencies",
  }),
  freezeRecord({
    passName: "hgoPreview",
