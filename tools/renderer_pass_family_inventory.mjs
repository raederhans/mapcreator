...
export const RENDER_PASS_FAMILY_INVENTORY = Object.freeze([
  freezeRecord({
    ...
    notes: "foundational background ownership held for later review",
  }),
  freezeRecord({
  ...
  freezeRecord({
    ...
    browserLanes: ["test:e2e:scenario-resilience", "test:e2e:tno-contracts"],
    perfSensitivity: "high",
    notes: "P3.3a preflight scope only",
  }),
  freezeRecord({
    passName: "hgoPreview",
  ...
  freezeRecord({
    ...
    plannedPhase: "P3.1",
    riskTier: "medium",
    stateReadClass: ["viewport", "appearance", "map-data", "interaction", "render-cache", "clock"],
    stateWriteClass: ["pass-surface", "owner-cache", "runtime-state", "diagnostics"],
    canvasOrSvg: "canvas",
  ...
  freezeRecord({
    ...
    stateWriteClass: ["pass-surface", "owner-cache", "diagnostics"],
    canvasOrSvg: "canvas",
    existingDependencyOwners: ["js/core/renderer/border_draw_owner.js"],
    browserLanes: ["test:e2e:layer:regression", "test:e2e:tno-contracts"],
    perfSensitivity: "high",
    notes: "HGO and data guards remain in the wrapper; main border draw delegates to the existing owner",
  }),
  freezeRecord({
  ...
  freezeRecord({
    ...
    browserLanes: ["test:e2e:city-rendering"],
    perfSensitivity: "medium",
    notes: "blank labels stay inline; city labels delegate; future review",
  }),
]);
