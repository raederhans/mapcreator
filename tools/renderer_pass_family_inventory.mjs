...
export const RENDER_PASS_FAMILY_INVENTORY = Object.freeze([
  freezeRecord({
    ...
    currentOwnerPath: "js/core/map_renderer.js",
    plannedPhase: "hold",
    riskTier: "high",
  ...
  freezeRecord({
    ...
    currentOwnerPath: "js/core/renderer/physical_layer_render_owner.js",
  ...
  freezeRecord({
    ...
    implementationStatus: "delegated-existing",
    currentOwnerPath: "js/core/map_renderer/hgo_runtime_preview_render_owner.js",
    plannedPhase: "existing-delegated",
    riskTier: "medium",
    stateReadClass: ["viewport", "scenario", "map-data", "interaction", "render-cache"],
    stateWriteClass: ["pass-surface", "owner-cache", "diagnostics"],
    canvasOrSvg: "canvas",
    existingDependencyOwners: ["js/core/map_renderer/hgo_runtime_preview_frame_commit.js"],
    browserLanes: [],
    perfSensitivity: "high",
