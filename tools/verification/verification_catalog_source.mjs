...
const GATE_POLICY_SIGNAL_NAMES = Object.freeze([
  "requiresStrictTno",
  "requiresDemo",
  "requiresTestInfra",
...
function gatePolicyAuthorityDigest(authority) {
...
export function projectVerificationGatePolicySignals({
  changedFiles = [],
  matchedByFile = [],
  unmatchedChangedFiles = [],
  routeAuthority = [],
} = {}) {
  const authority = VERIFICATION_GATE_POLICY_AUTHORITY;
  ...
  return {
    ...
    authorityIdentity: structuredClone(VERIFICATION_GATE_POLICY_AUTHORITY_IDENTITY),
    signals,
  };
}
