...
export const VERIFICATION_DOMAINS = Object.freeze([
  ...
  Object.freeze({
    ...
    commandType: "package-script",
    packageScriptRequired: true,
    sourceRefs: [...P4_4_SOURCE_REFS, "package.json"],
    domain: "state-ownership",
    ownerHint: "state-ownership",
    layer: "contract",
    cost: "contract",
  ...
  Object.freeze({
    ...
    sourceRefs: [
      ...P4_4_SOURCE_REFS,
      ...P4_EXACT_PHASE_CONTROL_SOURCE_REFS,
    ],
    domain: "state-ownership",
    ownerHint: "state-ownership",
    layer: "contract",
  ...
  Object.freeze({
    id: "verify-core:p4:p4-5a-runtime-hook-semantics",
    commandRef: "test:node:p4:p4-5a",
    commandType: "package-script",
    packageScriptRequired: true,
    sourceRefs: [...P4_5A_SOURCE_REFS, "package.json"],
    domain: "state-ownership",
    ownerHint: "state-ownership",
    layer: "contract",
    cost: "contract",
  ...
  Object.freeze({
    id: "verify-core:p4:p4-5a-runtime-hook-boundary",
    commandRef: "test:python:p4:p4-5a-boundary",
    commandType: "package-script",
    packageScriptRequired: true,
    sourceRefs: [...P4_5A_SOURCE_REFS, "package.json"],
    domain: "state-ownership",
  ...
  Object.freeze({
    id: "p4:p4-5a-exact-phase",
    commandRef: "verify:p4:p4-5a",
    commandType: "package-script",
    packageScriptRequired: true,
    sourceRefs: [
      ...P4_5A_SOURCE_REFS,
  ...
  Object.freeze({
    id: "verify-core:p4:p4-5b-runtime-hook-integration",
    commandRef: "test:node:p4:p4-5b",
    commandType: "package-script",
    packageScriptRequired: true,
    sourceRefs: [...P4_5B_SOURCE_REFS, "package.json"],
    domain: "state-ownership",
    ownerHint: "state-ownership",
    layer: "contract",
    cost: "contract",
  ...
  Object.freeze({
    id: "verify-core:p4:p4-5b-runtime-hook-integration-boundary",
    commandRef: "test:python:p4:p4-5b-boundary",
    commandType: "package-script",
    packageScriptRequired: true,
    sourceRefs: [...P4_5B_SOURCE_REFS, "package.json"],
    domain: "state-ownership",
  ...
  Object.freeze({
    id: "p4:p4-5b-exact-phase",
    commandRef: "verify:p4:p4-5b",
    commandType: "package-script",
    packageScriptRequired: true,
    sourceRefs: [
      ...P4_5A_SOURCE_REFS,
