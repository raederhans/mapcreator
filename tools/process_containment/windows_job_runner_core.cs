...
internal static partial class ScenarioForgeWindowsJobRunnerCore
{
    ...
    private static RunnerSpec ReadSpec(string protocolId)
    {
        ...
        string error)
    {
        ...
        string json = "{" +
            "\"schemaVersion\":1," +
            "\"protocolId\":\"" + JsonEscape(protocolId) + "\"," +
    ...
    public static int Run(string protocolId)
    {
        if (String.IsNullOrWhiteSpace(protocolId)) throw new ArgumentException("protocolId is required", "protocolId");
