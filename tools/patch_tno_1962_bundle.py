...
def resolve_default_checkpoint_dir(scenario_dir: Path = SCENARIO_DIR) -> Path:
    session = ensure_scenario_build_session(
        scenario_id=SCENARIO_ID,
        scenario_dir=scenario_dir,
        root=ROOT,
    )
    return Path(session["buildDir"])


def _record_checkpoint_stage_outputs(
    checkpoint_dir: Path,
    *,
    scenario_dir: Path,
    stage: str,
...
TNO_NAMED_MARGINAL_WATER_SPECS = (
    ...
    },
    {
        ...
        "is_chokepoint": False,
        "source_layer": "seavox_v19",
        "source_query": "mrgid_sr='24205'",
        "source_standard": "marine_regions_seavox_v19",
        "subtract_base_ids": (),
        "simplify_tolerance": 0.004,
    },
    {
        "id": "tno_plymouth_sound",
        "name": "Plymouth Sound",
    ...
    },
    {
        ...
        "source_standard": "marine_regions_seavox_v19",
        "subtract_base_ids": (),
        "subtract_named_ids": ("tno_gulf_of_alaska", "tno_anadyrskiy_zaliv"),
        "clip_open_ocean_ids": (
            "tno_northwest_pacific_ocean",
            "tno_northeast_pacific_ocean",
        ),
    ...
    {
        "id": "tno_anadyrskiy_zaliv",
        "name": "Anadyrskiy Zaliv",
        "label": "Anadyrskiy Zaliv",
        "water_type": "gulf",
        "region_group": "marine_detail",
        "parent_id": "tno_bering_sea",
        "is_chokepoint": False,
        "source_layer": "seavox_v19",
        "source_query": "mrgid_sr='24121'",
        "source_standard": "marine_regions_seavox_v19",
        "subtract_base_ids": (),
        "clip_open_ocean_ids": (
            "tno_northwest_pacific_ocean",
    ...
    },
    {
        ...
        "subtract_named_ids": ("tno_norwegian_sea", "tno_fram_strait"),
    ...
    },
    {
        ...
        "water_type": "strait",
        "region_group": "marine_detail",
        "parent_id": "tno_greenland_sea",
        "is_chokepoint": True,
        "source_layer": "seavox_v19",
        "source_query": "mrgid_sr='26579'",
        "source_standard": "marine_regions_seavox_v19",
        "subtract_base_ids": (),
        "clip_open_ocean_ids": TNO_ATLANTIC_OPEN_OCEAN_IDS + TNO_ARCTIC_OPEN_OCEAN_IDS,
        "simplify_tolerance": 0.004,
    ...
    },
    {
        ...
        "subtract_named_ids": ("tno_hudson_strait",),
        "clip_open_ocean_ids": ("tno_northwest_atlantic_ocean", "tno_western_arctic_ocean"),
        "simplify_tolerance": 0.01,
    },
    {
        "id": "tno_hudson_strait",
        "name": "Hudson Strait",
        "label": "Hudson Strait",
        "water_type": "strait",
        "region_group": "marine_detail",
        "parent_id": "tno_hudson_bay",
        "is_chokepoint": True,
        "source_layer": "seavox_v19",
        "source_query": "mrgid_sr='24017'",
        "source_standard": "marine_regions_seavox_v19",
        "subtract_base_ids": (),
        "clip_open_ocean_ids": ("tno_northwest_atlantic_ocean", "tno_western_arctic_ocean"),
        "simplify_tolerance": 0.004,
    ...
    },
    {
        ...
        "subtract_base_ids": (),
        "supplement_bboxes": (
            (-0.23, 53.60, -0.13, 53.67),
        ),
        "clip_against_land_mask": False,
        "simplify_tolerance": 0.004,
    },
    {
    ...
    },
    {
        ...
        "subtract_base_ids": (),
        "supplement_bboxes": (
            (-4.88, 51.98, -4.40, 52.22),
            (-4.67, 52.09, -4.59, 52.15),
        ),
        "supplement_respects_land_mask": False,
        "clip_against_land_mask": False,
        "simplify_tolerance": 0.004,
    },
    {
        "id": "tno_caernarfon_bay",
        "name": "Caernarfon Bay",
        "label": "Caernarfon Bay",
        "water_type": "bay",
        "region_group": "marine_detail",
        "parent_id": "tno_irish_sea",
        "is_chokepoint": False,
        "source_layer": "seavox_v19",
        "source_query": "mrgid_sr='24220'",
        "source_standard": "marine_regions_seavox_v19",
        "subtract_base_ids": (),
        "simplify_tolerance": 0.004,
    },
    ...
    },
    {
        ...
        "is_chokepoint": False,
        "source_layer": "seavox_v19",
        "source_query": "mrgid_sr='24034'",
        "source_standard": "marine_regions_seavox_v19",
        "exclude_base_ids": ("marine_scotia_sea",),
    ...
    },
    {
        ...
        "is_chokepoint": False,
        "source_layer": "seavox_v19",
        "source_query": "mrgid_sr='24035'",
        "source_standard": "marine_regions_seavox_v19",
        "exclude_base_ids": ("marine_weddell_sea",),
        "clip_open_ocean_ids": ("tno_south_atlantic_antarctic_ocean",),
        "simplify_tolerance": 0.02,
    },
    {
...
def apply_tno_named_water_supplements(named_features: list[dict], land_mask_geom) -> list[dict]:
    ...
    for spec in TNO_NAMED_MARGINAL_WATER_SPECS:
        ...
        if feature is None or current_geom is None:
            continue
        supplement_respects_land_mask = bool(spec.get("supplement_respects_land_mask", True))
        supplement_parts = []
        for supplement_bbox in spec.get("supplement_bboxes", ()) or ():
            ...
            if supplement_geom is None:
                continue
            if land_mask_geom is not None and supplement_respects_land_mask:
                supplement_geom = normalize_polygonal(supplement_geom.difference(land_mask_geom))
            if supplement_geom is None:
                continue
            subtract_geometries = [
...
def clip_named_water_features_to_land_mask(named_features: list[dict], land_mask_geom) -> list[dict]:
    if land_mask_geom is None:
        return list(named_features or [])
    spec_by_id = {
    ...
    for feature in named_features or []:
        properties = dict(feature.get("properties", {})) if isinstance(feature, dict) else {}
        feature_id = str(properties.get("id") or "").strip() or "<unknown>"
        current_geom = normalize_polygonal(shape(feature.get("geometry"))) if isinstance(feature, dict) and feature.get("geometry") else None
        if current_geom is None:
            raise ValueError(f"Named water feature '{feature_id}' has empty geometry before land-mask clipping.")
        clip_against_land_mask = bool(spec_by_id.get(feature_id, {}).get("clip_against_land_mask", True))
        if not clip_against_land_mask:
            clipped_features.append(make_feature(current_geom, properties))
            continue
        clipped_geom = normalize_polygonal(current_geom.difference(land_mask_geom))
        if clipped_geom is None:
...
def build_water_stage_state_from_countries_state(
    ...
    named_marginal_water_features = clip_named_water_features_to_land_mask(
        named_marginal_water_features,
        ocean_land_mask_geom,
    )
...
def main() -> None:
    ...
    checkpoint_dir = (
        ...
        else resolve_default_checkpoint_dir(scenario_dir)
    )
