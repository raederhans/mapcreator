...
- P3.1 clean-head `verify:dist-drift`, `verify:core`, browser, and standard performance acceptance remain the current live-process-owner tasks before P3.2 begins.
