...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `C:\Users\raede\Desktop\dev\mapcreator` | `main` / `9a5febfe` | `9a5febfe` | clean at last pre-final check | Main checkout | main branch | status clean before final integration branch merge | Green | Receive final integration after branch is verified |
| `C:\Users\raede\Desktop\dev\mapcreator-data-chain-integration-2026-06-14` | `codex/data-chain-integration-2026-06-14` / `59ef139a+audit WIP` | `fba1b710` plus merged `origin/main` `9a5febfe` | in-progress | Integration owner for data chain continuation | registry, data, renderer, transport, chunk generator, appearance/i18n Pages surface | data-quality, Phase 2-4, render selective, origin/main merge, and audit selective gates passed | Red owner branch | Commit audit selective batch, run final review/QA gate, push, then merge to main |
...
| `C:\Users\raede\Desktop\dev\mapcreator-audit-20260612-appearance-transport` | `codex/audit-20260612-appearance-transport` / `01811500` | `cf2a57a1` | integrated-selectively | Appearance preset/i18n audit fixes | `index.html`, `dist/app/index.html`, appearance preset state, i18n catalog | selected 9 target files plus regenerated Pages manifest; JSON, node tests, `verify:pages-dist`, and `git diff --check` passed | Resolved | Keep worktree as recoverable reference until final main integration |
...
4. Commit state: integration branch has committed data-quality, data-chain, scenario alignment, and current-main merge commits; audit selective batch is pending final commit.
