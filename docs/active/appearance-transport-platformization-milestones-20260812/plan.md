...
- A：以 final source review-fix commit `2ee6653f812febd69148f659b5baee7fe1e3edf8` 及其 coordination descendant 为候选源，完成 P4.3 renderer actions 的 policy、performance、routes 与正式准入。
