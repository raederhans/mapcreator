...
The governed tooling landed locally in Lore commit `14878c78937f36f9ddee53a876521494a2214cbb`. Clean-head `verify:dist-drift` exited 0 and `verify:core` passed 62/62, with logs under `.runtime/tests/renderer-frame-orchestration-p2-20260710/perf-role-governance-14878c78/`. A final offline rerun reproduced JSON SHA256 `6f76b274a7827c1c6b7baac68508e40dbafb521206cdc85c1e06c03c42790245` and Markdown SHA256 `bed108df85b38aaf803287b3354332e0023868235767aea7500c5bad88d52305`; the original legacy report remains `f601896f26478ae9e023d97d0193e281cb8a0c3931fdcd8fa4bccebe03f4d839`. This closes the deterministic prerequisite and leaves P2.2a ready under the registered single-owner browser/performance protocol.
