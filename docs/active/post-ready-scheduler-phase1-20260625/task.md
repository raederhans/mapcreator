...
- Integration state: integrated and pushed through `bcfa9eb63d8837bd0461991a13706587666f7082`; changed files are limited to phase1 source/tests/docs plus necessary dist mirror updates.
