...
- [x] Run review/QA.
- [ ] Commit, integrate, push, and clean worktree.
...
6. Commit state: not committed yet; final static review issue fixed and revalidated.
...
10. Recommended next step: commit this branch, fast-forward merge to main after review, push, then clean the worktree.
