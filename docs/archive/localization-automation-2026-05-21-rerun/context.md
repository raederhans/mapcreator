...
- Existing unrelated worktree noise includes `.omx/*` runtime files plus pre-existing repo edits in `js/core/scenario/chunk_runtime.js`, `js/core/state_defaults.js`, `js/core/transport_capability_registry.js`, and `js/main.js`; this run left them untouched.
