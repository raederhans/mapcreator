...
| UQA-HGO-004 | Inspect outside HGO viewport while preview owns canvas | Passed: HGO inspect returned null, cleared inspect result, and kept the underlying map hit path blocked by preview ownership |
