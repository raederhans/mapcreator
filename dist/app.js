...
const translations = {
  en: {
    ...
    previewBody:
      "The Japan view lets visitors switch between roads, rail, cities, terrain, and night context in a compact product preview.",
    ...
    previewPanelTransportTitle:
      "4794 road features and 1105 rail features are visible in the Japan preview.",
    previewPanelTransportBody:
      "Use this view to judge whether transport corridors and rail hubs are clear enough for a scenario map.",
    ...
    previewPanelCitiesBody:
      "City points give the map recognizable anchors, so viewers can read scale and regional density at a glance.",
  ...
  zh: {
    ...
    previewPanelTransportTitle: "日本预览中可查看 4794 个道路要素和 1105 个铁路要素。",
    previewPanelTransportBody: "这个视图用来判断交通走廊和铁路枢纽是否足够清晰，能否服务一张场景地图。",
