...
const translations = {
  en: {
    ...
    sampleProjectDownloadsBody: "Choose any public baseline and import the JSON from Project / Import.",
  ...
  zh: {
    ...
    sampleProjectDownloadsBody: "选择任意公开基线，然后在 Project / Import 中导入 JSON。",
