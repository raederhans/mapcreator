...
const translations = {
  en: {
    ...
    worksBody:
      "Each run pairs the final output with its scenario, layer stack, source markers, a downloadable project JSON, and a public path back to the demo.",
    ...
    sampleProjectActionsLabel: "Sample project downloads",
    sampleProjectOpen: "Open sample in editor",
    sampleProjectDownload: "Download project JSON",
    sampleRecipeManifest: "View recipe manifest",
    sampleProjectDownloadsTitle: "All sample project downloads",
    sampleProjectDownloadsBody: "Choose any public baseline, open it in the editor, or download the JSON for local import.",
    sampleProjectBlank: "Blank Map starter",
    sampleProjectModern: "Modern World Japan corridor",
  ...
  zh: {
    ...
    worksBody: "每个示例都保留最终成图、场景基线、图层组合、来源标记、可下载项目 JSON 和公开演示入口。",
    ...
    sampleProjectActionsLabel: "示例项目下载",
    sampleProjectOpen: "在编辑器中打开示例",
    sampleProjectDownload: "下载项目 JSON",
    sampleRecipeManifest: "查看配方清单",
    sampleProjectDownloadsTitle: "全部示例项目下载",
    sampleProjectDownloadsBody: "选择任意公开基线，可直接在编辑器中打开，也可下载 JSON 本地导入。",
    sampleProjectBlank: "Blank Map 起步项目",
    sampleProjectModern: "Modern World 日本走廊",
