...
const translations = {
  en: {
    ...
    updateThreeBody:
      "The checked-in catalog tracks 459 assets across source ledgers, transport manifests, topology, palettes, and runtime data.",
  ...
  zh: {
    ...
    updateThreeBody: "入库目录跟踪 459 个资产，覆盖来源台账、交通清单、拓扑、调色板和运行时数据。",
    ctaEyebrow: "打开工作台",
