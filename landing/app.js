...
const translations = {
  en: {
    ...
    updateThreeBody:
      "The checked-in catalog tracks 480 assets across source ledgers, transport manifests, topology, palettes, and runtime data.",
  ...
  zh: {
    ...
    updateThreeBody: "入库目录跟踪 480 个资产，覆盖来源台账、交通清单、拓扑、调色板和运行时数据。",
    ctaEyebrow: "打开工作台",
